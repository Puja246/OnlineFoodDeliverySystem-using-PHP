...
if(isset($_POST['submit'] )) 
{
	...
	$mql = "INSERT INTO users(username,f_name,l_name,email,phone,password,address,photo) VALUES('".$_POST['username']."','".$_POST['firstname']."','".$_POST['lastname']."','".$_POST['email']."','".$_POST['phone']."','".($_POST['password'])."','".$_POST['address']."','".$_FILES['pic']['name']."')";
	mysqli_query($db, $mql);
